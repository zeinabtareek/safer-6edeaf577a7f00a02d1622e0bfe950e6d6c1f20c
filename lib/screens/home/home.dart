    ...
    return Scaffold(
      ...
      bottomNavigationBar: Obx(
        () => BottomNavigationBar(
          ...
          items: [
            for (int i = 0; i < controller.bottomNavBarData.length; i++)
              BottomNavigationBarItem(
                icon: Image.asset(
                  controller. bottomNavBarData[i]['icon'],
                  height: 25.h,
                ),
                label: controller.bottomNavBarData[i]['label'],
                activeIcon: Container(
                  padding: K.fixedPaddingOnlyTopAndBottom,
                  width: 100,
                  decoration: K.boxDecorationLightBg,
                  child: Image.asset(
                    controller.  bottomNavBarData[i]['active'],
